...
class AttachmentsController extends AppController
{
    ...
    public function add()
    {
        ...
        $students = $this->Attachments->Students->find('list', ['limit' => 200]);
        $lecturers = $this->Attachments->Lecturers->find('list', ['limit' => 200]);
        $this->set(compact('attachment', 'students', 'lecturers'));
        $this->set('_serialize', ['attachment']);
    }
